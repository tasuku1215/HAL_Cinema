...
<section>
    ...
    <form action="/ph34/movieTheater/public/movieregist.php" method="post">
        <dl>
            <dt>映画名</dt>
            <dd>
            ...
            <dt>監督名</dt>
            <dd>
                <input type="text" id="directed" name="directed" required>
            </dd>
            <dt>主演名</dt>
            <dd>
            ...
            <dd>
             ...
             <dt>あらすじ</dt>
             <dd>
                 <textarea name="Synopsis"  id="Synopsis" rows="8" cols="80" required></textarea>
             </dd>
             <dt>画像</dt>
             <dd>
